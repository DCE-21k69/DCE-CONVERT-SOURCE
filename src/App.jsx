        ...
        {currentTool ? (
          ...
          <div>
            ...
            <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-14 px-2">
              ...
              <p className="mt-3 sm:mt-4 text-sm sm:text-base text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
              ...
              {/* Responsive Category Filter Pills (scrollable on mobile, centered on desktop) */}
              <div className="flex items-center gap-2 mt-6 sm:mt-8 overflow-x-auto pb-2 sm:pb-0 sm:justify-center no-scrollbar -mx-2 px-2">
                {[
                  ...
                  <button
                    ...
                    className={`shrink-0 px-3.5 sm:px-4 py-2 rounded-xl text-xs font-semibold transition active:scale-95 cursor-pointer select-none ${
            ...
            {/* Tools Grid (Responsive 1-col on mobile, 2-col on small tablet, 3-col on tablet, 4-col on desktop) */}
